        ...
        <div class="happy">
            ...
            <div class="item1">
                <ul class="firstbox">
                    ...
                    <li class="content1">Shivam</li>

                    <li class="content2">9819104641</li>

                    <li class="content3">Bangalore</li>
                    <li class="content4">India</li>
                    <li class="content5">Karnataka</li>
            ...
            <div class="item1">
                <ul class="firstbox">
                    ...
                    <li class="content1">Adarsh</li>

                    <li class="content2">8431258013</li>
