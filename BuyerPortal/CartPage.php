<!-- <?php
     ...
     // Include the product quantity validation function
     function validateProductQuantity($currentStock, $orderedQuantity) {
      ...
      // Get the current stock and ordered quantity from your data source
      $currentStock = 10;
      $orderedQuantity = 5;
      
      // Call the product quantity validation function
      validateProductQuantity($currentStock, $orderedQuantity);
      
      // Additional code for displaying cart items, totals, etc.
     ...
     <body>
          ...
          <div class="instaid">
               <div class="text"><a href="#" style="color:black;">@FreshFarm</a></div>
     
               <div class="gmailid">
                    <a href="#" class="hypher" style="color:black;">FreshFarm@gmail.com</a>
               </div>
