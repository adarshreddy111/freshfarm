						...
						<div class="card-body border border-dark">
							<form name="my-form" action="BuyerRegistration.php" method="post">
								...
								<div class="form-group row">
									...
									<div class="col-md-6">
										<input type="email" id="email_address" class="form-control border border-dark" name="email" placeholder="E-Mail ID" required>
									</div>
								</div>
...
if (isset($_POST['register'])) {
    ...
    if (!validateMobileNumber($phonenumber)) {
        echo "<script>alert('Invalid mobile number. Please enter a 10-digit mobile number.');</script>";
        exit; // Stop further execution if mobile number is invalid
    }
    ...
    if (strcmp($password, $confirmpassword) == 0) {
        ...
        $query = "INSERT INTO buyerregistration (buyer_name, buyer_phone, buyer_addr, buyer_mail, buyer_username, buyer_password) 
            VALUES ('$name', '$phonenumber', '$address', '$email', '$username', '$encryption')";
