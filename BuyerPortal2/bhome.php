            ...
            <div class="dropdown p-2 settings ">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    ...
                    if (isset($_SESSION['phonenumber'])) {
                        ...
                        echo "<a href='trackorder.php' class='dropdown-item ' style='padding-right:-20px;'>Track Order</a>";
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2 text-center">
                    <p><u><a href="https://www.FreshFarm.com/">FreshFarm</a></u> is a Multitrading Company for farmers and customers</p>
                    <p class="h6"><a class="text-green ml-2" href="https://www.google.com" target="_blank">FreshFarm</a></p>
                </div>
                </hr>
            </div>
        </div>
