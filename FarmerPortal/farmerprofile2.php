<?php
    ...
    while($row = mysqli_fetch_array($run_query))
    {
        ...
        $address = $row['farmer_addr'];
        $pan = $row['farmer_pan'];
        $bank = $row['farmer_bank'];
        $comp = $row['farmer_comp'];
        $license = $row['farmer_license'];
        $mail = $row['farmer_mail'];
    }   
...
<br>
    ...
    <div class="container" >
        <div class="form">
            ...
            <div class="input-group mt-4 s">
                <div class="input-group-prepend ">
                    <span class="input-group-text text  " id="inputGroup-sizing-default" ><i class="far fa-envelope mr-2"></i>State </span>
                </div>
                <input type="text" readonly class="form-control-plaintext border border-dark" id="staticEmail" value="<?php echo $State?> ">
            </div> 
            <div class="input-group mt-4 s">
                <div class="input-group-prepend ">
                    <span class="input-group-text text  " id="inputGroup-sizing-default" ><i class="far fa-envelope mr-2"></i>District </span>
                </div>
                <input type="text" readonly class="form-control-plaintext border border-dark" id="staticEmail" value="<?php echo $District?> ">
            </div> 
            <div class="input-group mt-4 s">
                <div class="input-group-prepend ">
                    <span class="input-group-text text  " id="inputGroup-sizing-default" ><i class="far fa-envelope mr-2"></i>Pan Number </span>
                </div>
                <input type="text" readonly class="form-control-plaintext border border-dark" id="staticEmail" value="<?php echo $panno?> ">
            </div> 

            <div class="input-group mt-4 s">
                <div class="input-group-prepend ">
                    <span class="input-group-text text  " id="inputGroup-sizing-default" ><i class="far fa-envelope mr-2"></i>Account Number </span>
                </div>
                <input type="text" readonly class="form-control-plaintext border border-dark" id="staticEmail" value="<?php echo $accno?> ">
            </div> 
   <!-- #region 
-->
        </div>
